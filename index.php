	...
	<div class="wrapper">
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			...
			<a href="index.php" class="brand-link">
				<img src="assets/img/LOGO DPRD.png" width="" 
				alt="AdminLTE Logo" class="brand-image" style="opacity: .8">
				<span class="brand-text"> DATA STAFF HUMAS</span>
			</a>
			...
			<div class="sidebar">
				...
				<nav class="mt-2">
					<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
						...
						<li class="nav-item">
							<a href="?page=tamu" class="nav-link">
						...
						<li class="nav-item">
							<a href="?page=kunjungan" class="nav-link">
								<i class="nav-icon fas fa-fw fa-table"></i>
								<p>
									Tamu Kunjungan DPRD
								</p>
					...
					if(isset($_GET['page'])){
						...
						//Klik Halaman Home Pengguna
							...
							break;
								...
								//Tamu
								case 'tamu':
									include "admin/tamu/tamu.php";
									break;
								case 'view-tamu':
									include "admin/tamu/view_tamu.php";
									break;
								case 'del-tamu':
									include "admin/tamu/del_tamu.php";
									break;
									case 'rekap':
										include "rekap.php";
										break;			
								...
								//Tamu
								case 'kunjungan':
									include "admin/kunjungan/kunjungan.php";
									break;
								case 'view-kunjungan':
									include "admin/kunjungan/view_kunjungan.php";
									break;
								case 'del-kunjungan':
		...
		<footer class="main-footer">
			<div class="float-right d-none d-sm-block">
				Copyright &copy;
				<a target="_blank" href="http://dprd-cirebonkab.go.id/">
					<strong> Humas</strong>
				</a>
