...
<?php
	$sql = $koneksi->query("SELECT count(nama) as putra from tamu ");
	while ($data= $sql->fetch_assoc()) {
...
<?php
	$sql = $koneksi->query("SELECT count(nama) as putri from kunjungan");
	while ($data= $sql->fetch_assoc()) {
...
<div class="row">
	...
	<div class="col-lg-3 col-6">
		...
		<div class="small-box bg-success">
			...
			<a href="index.php?page=tamu" class="small-box-footer">Selengkapnya
			<i class="fas fa-arrow-circle-right"></i>
			</a>
		</div>
	</div>
	...
	<div class="col-lg-3 col-6">
		...
		<div class="small-box bg-danger">
			...
			<a href="index.php?page=kunjungan" class="small-box-footer">Selengkapnya
			<i class="fas fa-arrow-circle-right"></i>
			</a>
		</div>
	</div>
